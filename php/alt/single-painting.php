        ...
        <section id='descriptionSec'>
            ...
            <div id='details' class='tabcontent'>
                ...
                if (is_null($painting['WikiLink'])) {
                    ...
                    echo "<a href='" . $painting['WikiLink'] . "'>Wikipedia Link</a>";
                }
            ...
            <div id='colours' class='tabcontent'>
                ...
                <?php
                $source_file = "../images/paintings/square/" . $painting['ImageFileName'] . ".jpg";
...
<!--CITATION: w3schools.com How TO- Tabs. Retrieved from: https://www.w3schools.com/howto/howto_js_tabs.asp-->